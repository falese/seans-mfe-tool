...
- Lifecycle hook execution semantics
- Type system definition and validation
- Handler discovery and invocation patterns
...
1. ✅ Non-mandatory hooks that fail → **fail silently** (log telemetry, continue chain)
...
4. ✅ **`main` phase failures propagate** - capability returns error to caller
