...
| G28 | No versioning/upgrade guide for `@falese/smt-contracts` consumers | 1 | Adopter | S3 | S | Packages owner | Document semver policy + upgrade notes (ties to MERGE-PLAN Phase 1) | Versioning policy + upgrade guide published | MERGE-PLAN |
