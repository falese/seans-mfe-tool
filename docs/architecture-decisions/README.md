...
| [PDR-006](../product-decisions/PDR-006-ecosystem-scaling-thesis.md) — Ecosystem scaling thesis | [ADR-083](./ADR-083-runtime-barrel-stays-polyglot.md) The runtime barrel carries no framework; the specialized abstracts live behind subpaths |
