...
Defined in: [packages/contracts/src/envelope.ts:151](https://github.com/falese/seans-mfe-tool/blob/main/packages/contracts/src/envelope.ts#L151)
...
`Partial`\<\{ `correlationId`: `string`; `durationMs`: `number`; `traceId`: `string`; \}\>
