...
[seans-mfe-tool API reference](../../../README.md) / [contracts/src](../README.md) / isPlatformCapability

# Function: isPlatformCapability()
...
value is "describe" \| "load" \| "render" \| "refresh" \| "emit" \| "query" \| "schema" \| "authorizeAccess" \| "health" \| "updateControlPlaneState"
