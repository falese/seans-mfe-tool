...
[seans-mfe-tool API reference](../../../README.md) / [dsl/src](../README.md) / validateManifest
...
Raw data to validate (from YAML parse)

## Returns

[`ValidationResult`](../interfaces/ValidationResult.md)

Validation result with typed manifest if valid
