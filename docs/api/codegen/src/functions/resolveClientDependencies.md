...
[seans-mfe-tool API reference](../../../README.md) / [codegen/src](../README.md) / resolveClientDependencies

# Function: resolveClientDependencies()

> **resolveClientDependencies**(`manifest`, `framework`): `Record`\<`string`, `string`\>

Defined in: [packages/codegen/src/dependencies.ts:94](https://github.com/falese/seans-mfe-tool/blob/main/packages/codegen/src/dependencies.ts#L94)
