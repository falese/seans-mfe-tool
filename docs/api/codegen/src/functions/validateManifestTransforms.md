...
[seans-mfe-tool API reference](../../../README.md) / [codegen/src](../README.md) / validateManifestTransforms

# Function: validateManifestTransforms()

> **validateManifestTransforms**(`manifest`): [`ValidationResult`](../interfaces/ValidationResult.md)

Defined in: [packages/codegen/src/manifest-validation.ts:95](https://github.com/falese/seans-mfe-tool/blob/main/packages/codegen/src/manifest-validation.ts#L95)
