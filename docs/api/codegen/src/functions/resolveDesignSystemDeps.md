...
[seans-mfe-tool API reference](../../../README.md) / [codegen/src](../README.md) / resolveDesignSystemDeps

# Function: resolveDesignSystemDeps()

> **resolveDesignSystemDeps**(`manifest`, `framework`): `Record`\<`string`, `string`\>

Defined in: [packages/codegen/src/dependencies.ts:47](https://github.com/falese/seans-mfe-tool/blob/main/packages/codegen/src/dependencies.ts#L47)
