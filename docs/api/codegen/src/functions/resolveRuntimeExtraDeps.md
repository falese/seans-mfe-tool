...
[seans-mfe-tool API reference](../../../README.md) / [codegen/src](../README.md) / resolveRuntimeExtraDeps

# Function: resolveRuntimeExtraDeps()

> **resolveRuntimeExtraDeps**(`manifest`, `framework`): `Record`\<`string`, `string`\>

Defined in: [packages/codegen/src/dependencies.ts:74](https://github.com/falese/seans-mfe-tool/blob/main/packages/codegen/src/dependencies.ts#L74)
