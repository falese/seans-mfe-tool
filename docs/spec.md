...
| [ADR-078](./architecture-decisions/ADR-078-control-plane-in-platform.md) | The control plane ships in the platform, and a composition environment is generated from a manifest | Control plane / codegen / packaging | Accepted (impl phased, #139) |
...
| [ADR-092](./architecture-decisions/ADR-092-the-generator-is-a-library.md) | The generator is a library — it returns diagnostics instead of printing, and receives file contributions instead of reaching across packages for them | Codegen / packaging / DX | Implemented |
