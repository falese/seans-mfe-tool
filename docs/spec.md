...
| [ADR-095](./architecture-decisions/ADR-095-demo-deployment-token-authentication.md) | Every request across the deployed fleet carries a verified bearer token, minted by a single demo login | Security / authentication | Proposed |
