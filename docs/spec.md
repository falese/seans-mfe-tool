...
| [ADR-085](./architecture-decisions/ADR-085-coder-intent-compiler-seam.md) | Intent-compilation is a resolved plugin capability; coder is its tunable open-weight implementation, external | AI / plugins / coder / generation | Proposed |
