/**
 * CommandResult envelope contract for --json mode.
 *
 * Every command that supports --json emits exactly ONE line on stdout:
 * a JSON-serialised CommandResult<T>. All other output goes to stderr.
 *
 * Refs #100 (B1)
 */

import { randomUUID } from 'crypto';
import { classifyError } from '../runtime/error-classifier';
