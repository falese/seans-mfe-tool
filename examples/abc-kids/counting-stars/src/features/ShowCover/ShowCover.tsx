...
export const ShowCover: React.FC = () => (
  <div style={{ maxWidth: 340, margin: '0 auto', borderRadius: 16, overflow: 'hidden',
    background: '#1a237e', color: '#fff', textAlign: 'center', padding: 24,
    fontFamily: 'system-ui, sans-serif' }}>
    <div style={{ fontSize: 72 }}>⭐</div>
    <h2 style={{ margin: '8px 0' }}>Counting Stars</h2>
    <p style={{ opacity: 0.85 }}>Counting Stars — tap exactly the right number of stars!</p>
