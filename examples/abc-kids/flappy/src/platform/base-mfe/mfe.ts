    ...
    switch (name) {
      ...
      default:
        throw new ValidationError(
          `[abckidsflappyMFE] loadDomainComponent: unknown component "${name}"`,
