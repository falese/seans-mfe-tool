...
export type HttpMethod =
  ...
  listPets: InContextSdkMethod<Query['listPets'], QuerylistPetsArgs, BaseMeshContext>,
  /** Get pet by id **/

  getPet: InContextSdkMethod<Query['getPet'], QuerygetPetArgs, BaseMeshContext>
  };

  export type MutationSdk = {
      /** Create a pet **/

  createPet: InContextSdkMethod<Mutation['createPet'], MutationcreatePetArgs, BaseMeshContext>
  };
