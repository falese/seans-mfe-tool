...
export type Pet = {
  ...
  status: QueryListPetsItemsStatus;
  tag?: Maybe<Scalars['String']['output']>;
};

export type QueryListPetsItemsStatus =
  | 'available'
  | 'pending'
  | 'sold';
...
export type ResolversTypes = ResolversObject<{
  ...
  QueryListPetsItemsStatus: QueryListPetsItemsStatus;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  listPets?: Resolver<Maybe<Array<Maybe<ResolversTypes['Pet']>>>, ParentType, ContextType, RequireFields<QuerylistPetsArgs, 'limit'>>;
...
export type PetResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Pet'] = ResolversParentTypes['Pet']> = ResolversObject<{
  ...
  status?: Resolver<ResolversTypes['QueryListPetsItemsStatus'], ParentType, ContextType>;
...
export type MeshInContextSDK = PetStoreApiTypes.Context;
...
const petStoreApiHandler = new PetStoreApiHandler({
              name: "PetStoreAPI",
              config: {"source":"./specs/petstore.yaml","operationHeaders":{"Authorization":"Bearer {context.jwt}","X-Request-ID":"{context.requestId}"}},
              baseDir,
              cache,
              pubsub,
...
transforms[0] = new RootTransform_0({
            apiName: '',
            config: {"mode":"bare","compositions":[{"resolver":"Query.*","composer":"./mock-switch#mockSwitch"}]},
            baseDir,
            cache,
            pubsub,
            importFn,
...
const importedAdditionalEnvelopPlugins = await import("../mesh-context.js").then(handleImport);
