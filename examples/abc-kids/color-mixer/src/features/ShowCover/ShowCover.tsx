...
export const ShowCover: React.FC = () => (
  <div style={{ maxWidth: 340, margin: '0 auto', borderRadius: 16, overflow: 'hidden',
    background: '#4a148c', color: '#fff', textAlign: 'center', padding: 24,
    fontFamily: 'system-ui, sans-serif' }}>
    <div style={{ fontSize: 72 }}>🎨</div>
    <h2 style={{ margin: '8px 0' }}>Color Mixer</h2>
    <p style={{ opacity: 0.85 }}>Color Mixer — mix two paints to make the target color!</p>
