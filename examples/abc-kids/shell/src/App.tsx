/**
 * ABC Kids shell — a 100% generic, daemon-driven layout host (ADR-055).
 *
...
const DAEMON_WS_URL: string = process.env.DAEMON_WS_URL || 'ws://localhost:3004/graphql';
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7f7fb' }}>
      ...
      {!hasExperiences && (
        ...
        >
          Waiting for the control plane to compose this application…
        </p>
      )}
