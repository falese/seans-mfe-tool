...
export const ShowCover: React.FC = () => (
  <div style={{ maxWidth: 340, margin: '0 auto', borderRadius: 16, overflow: 'hidden',
    background: '#1b5e20', color: '#fff', textAlign: 'center', padding: 24,
    fontFamily: 'system-ui, sans-serif' }}>
    <div style={{ fontSize: 72 }}>🌀</div>
    <h2 style={{ margin: '8px 0' }}>Maze Runner</h2>
    <p style={{ opacity: 0.85 }}>Maze Runner — steer through the maze to reach the flag!</p>
