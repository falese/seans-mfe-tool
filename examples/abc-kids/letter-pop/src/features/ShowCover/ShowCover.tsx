...
export const ShowCover: React.FC = () => (
  <div style={{ maxWidth: 340, margin: '0 auto', borderRadius: 16, overflow: 'hidden',
    background: '#b71c1c', color: '#fff', textAlign: 'center', padding: 24,
    fontFamily: 'system-ui, sans-serif' }}>
    <div style={{ fontSize: 72 }}>🎈</div>
    <h2 style={{ margin: '8px 0' }}>Letter Pop</h2>
    <p style={{ opacity: 0.85 }}>Letter Pop — pop the balloons in alphabetical order!</p>
