...
export const ShowCover: React.FC = () => (
  <div style={{ maxWidth: 340, margin: '0 auto', borderRadius: 16, overflow: 'hidden',
    background: '#263238', color: '#fff', textAlign: 'center', padding: 24,
    fontFamily: 'system-ui, sans-serif' }}>
    <div style={{ fontSize: 72 }}>🥁</div>
    <h2 style={{ margin: '8px 0' }}>Rhythm Tap</h2>
    <p style={{ opacity: 0.85 }}>Rhythm Tap — watch the pattern, then drum it back!</p>
