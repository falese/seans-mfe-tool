...
export const ShowCover: React.FC = () => (
  <div style={{ maxWidth: 340, margin: '0 auto', borderRadius: 16, overflow: 'hidden',
    background: '#004d40', color: '#fff', textAlign: 'center', padding: 24,
    fontFamily: 'system-ui, sans-serif' }}>
    <div style={{ fontSize: 72 }}>🔷</div>
    <h2 style={{ margin: '8px 0' }}>Shape Sorter</h2>
    <p style={{ opacity: 0.85 }}>Shape Sorter — find the shape that matches the word!</p>
