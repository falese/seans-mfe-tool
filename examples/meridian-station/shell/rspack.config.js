...
module.exports = {
  ...
  plugins: [
    new rspack.DefinePlugin({
      ...
      // Default 4504: the Meridian daemon (registry is 4500).
      'process.env.DAEMON_WS_URL': JSON.stringify(process.env.DAEMON_WS_URL || 'ws://localhost:4504/graphql'),
    }),
    ...
    new ModuleFederationPlugin({
      name: 'meridian_shell',
      // No static remotes: every MFE arrives via control-plane
      ...
      shared: {
        ...
        '@angular/platform-browser':  { singleton: true, requiredVersion: '^19.0.0' },
      },
    }),
  ],
};
