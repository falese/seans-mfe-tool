...
app.listen(port, () => {
  console.log(`🚀 meridian-docking-simulation BFF server running on port ${port}`);
  console.log(`   GraphQL endpoint: http://localhost:${port}/graphql`);

  console.log(`   Static assets: http://localhost:${port}/`);

  console.log(`   Health check: http://localhost:${port}/health`);
  console.log(`   Note: MFE assets served by rspack dev server on port 5007`);
});
