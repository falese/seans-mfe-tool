...
export type Query = {
  ...
  payroll?: Maybe<Array<Maybe<Payroll>>>;
};
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  crew?: Resolver<Maybe<Array<Maybe<ResolversTypes['Crew']>>>, ParentType, ContextType, RequireFields<QuerycrewArgs, 'Page' | 'PageSize'>>;
  certifications?: Resolver<Maybe<Array<Maybe<ResolversTypes['Certification']>>>, ParentType, ContextType, RequireFields<QuerycertificationsArgs, 'Page' | 'PageSize'>>;
  ...
  payroll?: Resolver<Maybe<Array<Maybe<ResolversTypes['Payroll']>>>, ParentType, ContextType, RequireFields<QuerypayrollArgs, 'pageSize'>>;
}>;
...
export type MeshInContextSDK = StationOsTypes.Context & StellarLedgerTypes.Context;
...
stationOsTransforms[0] = new StationOsTransforms_0({
                  apiName: "StationOS",
                  config: [{"typeName":"Query","pathConfig":["GetCrew","Data"],"newFieldName":"crew"},{"typeName":"Query","pathConfig":["GetCertifications","Data"],"newFieldName":"certifications"}],
                  baseDir,
                  cache,
                  pubsub,
                  importFn,
...
stellarLedgerTransforms[0] = new StellarLedgerTransforms_0({
                  ...
                  config: [{"typeName":"Query","pathConfig":["listPayroll","result"],"newFieldName":"payroll"}],
                  baseDir,
                  cache,
                  pubsub,
                  importFn,
