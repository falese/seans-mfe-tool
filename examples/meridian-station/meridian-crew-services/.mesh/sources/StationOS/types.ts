...
export type HTTPMethod =
  ...
  crew: InContextSdkMethod<Query['crew'], QuerycrewArgs, BaseMeshContext>,
  
  certifications: InContextSdkMethod<Query['certifications'], QuerycertificationsArgs, BaseMeshContext>
  };
