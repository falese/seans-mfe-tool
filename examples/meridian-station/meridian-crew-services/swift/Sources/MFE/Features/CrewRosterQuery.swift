...
//
// DEVELOPER-OWNED. The GraphQL document backing the CrewRoster capability.
//
...
public enum CrewRosterQuery {
    /// TODO: replace with a real query against your BFF's schema.
    ///
    /// Whatever this selects must decode into `CrewRosterOutputs`
